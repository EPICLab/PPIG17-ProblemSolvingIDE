...
In the context of programming, the language of problem-solving must transition from the generic nature described in psychology literature (\bold{cite cog. phsy. literature about problem-solving}) to a domain-specific language that exemplifies the particular activities involved.
